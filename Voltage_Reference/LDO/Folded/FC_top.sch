...
C {LDO/Folded/FC_pfets_x4.sym} -420 -870 0 0 {name=x1}
C {LDO/Folded/FC_pfets_x4.sym} -420 -470 0 0 {name=x2}
C {LDO/Folded/FC_pfets_x4.sym} 210 -640 0 0 {name=x3}
C {LDO/Folded/FC_pfets_x4.sym} 210 -880 0 0 {name=x4}
...
C {LDO/Folded/FC_bias_net.sym} -300 290 0 0 {name=x11}
...
C {LDO/Folded/FC_nfets_x2.sym} 200 40 0 0 {name=x6}
C {LDO/Folded/FC_nfets.sym} 200 -330 0 0 {name=x8}
