...
N 1385 -70 1385 -45 {
lab=GND}
C {devices/code_shown.sym} 210 -450 0 0 {name=DUT only_toplevel=true
...
C {devices/code_shown.sym} -105 410 0 0 {name=SPICE1 only_toplevel=false
value="
vvdd vdd 0 3.3
vcurr curr 0 0
vibias ibias 0 0
...
C {devices/code_shown.sym} 230 -310 0 0 {name=MODELS1 only_toplevel=true
format="tcleval( @value )"
value="
...
spiceprefix=X
m=4}
C {devices/capa.sym} 1385 -100 0 0 {name=C2
m=1
value=30p
footprint=1206
device="ceramic capacitor"}
C {devices/gnd.sym} 1385 -45 0 1 {name=l3 lab=GND}
C {devices/lab_pin.sym} 1325 -130 3 1 {name=p20 sig_type=std_logic lab=PAD0
}
