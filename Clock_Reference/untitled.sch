...
S {}
E {}
B 2 190 -80 990 320 {flags=graph
y1=-0.079
y2=3.7
ypos1=0
ypos2=2
...
linewidth_mult=4
dataset=1}
B 2 190 320 990 720 {flags=graph
...
N -510 -100 -510 -60 {
lab=S}
C {devices/code_shown.sym} 270 -440 0 0 {name=DUT only_toplevel=true
...
C {devices/code_shown.sym} 1000 -300 0 0 {name=SPICE1 only_toplevel=false
value="
vvdd vdd 0 3.3
vcurr curr 0 0
vibias ibias 0 0
...
C {devices/code_shown.sym} 330 -290 0 0 {name=MODELS1 only_toplevel=true
format="tcleval( @value )"
value="
