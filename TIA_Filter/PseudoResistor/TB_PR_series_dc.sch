...
"
spice_ignore=true}
C {PRbiased_net.sym} 500 -550 0 0 {name=x6}
...
C {PRbiased_net.sym} 500 -370 0 0 {name=x1}
...
C {PRbiased_net.sym} 500 -190 0 0 {name=x4}
...
C {PRbiased_net.sym} 500 -10 0 0 {name=x5}
...
C {PRbiased_net.sym} 500 160 0 0 {name=x7}
...
C {devices/vsource.sym} -850 -140 0 0 {name=VDD1 value=3.3}
C {devices/gnd.sym} -850 -90 0 0 {name=l9 lab=GND}
C {devices/lab_wire.sym} -820 -190 0 1 {name=p18 sig_type=std_logic lab=VDD}
C {devices/vsource.sym} -710 -150 0 0 {name=VX value=0}
C {devices/gnd.sym} -520 -160 0 0 {name=l12 lab=GND}
C {devices/lab_wire.sym} -680 -190 0 0 {name=p21 sig_type=std_logic lab=Vxa

}
C {devices/lab_wire.sym} -470 -280 0 0 {name=p22 sig_type=std_logic lab=Vxb}
C {devices/vsource.sym} -470 -140 0 0 {name=VB value=3.3}
C {devices/gnd.sym} -710 -40 0 0 {name=l11 lab=GND}
C {devices/gnd.sym} -560 -240 2 0 {name=l14 lab=GND}
C {devices/res.sym} -630 -180 1 0 {name=R1
value=100k
footprint=1206
device=resistor
m=1}
C {devices/res.sym} -520 -80 1 0 {name=R2
value=100k
footprint=1206
device=resistor
m=1}
C {devices/vsource.sym} -710 -90 0 0 {name=VB1 value=1.65}
C {devices/lab_wire.sym} -660 40 0 0 {name=p19 sig_type=std_logic lab=Vxa

}
C {devices/gnd.sym} -540 110 0 0 {name=l10 lab=GND}
C {devices/lab_wire.sym} -920 40 0 0 {name=p20 sig_type=std_logic lab=Vxb

}
C {devices/gnd.sym} -800 110 0 0 {name=l13 lab=GND}
C {devices/lab_wire.sym} -700 70 0 1 {name=p23 sig_type=std_logic lab=VB

}
C {devices/lab_wire.sym} -440 70 0 1 {name=p24 sig_type=std_logic lab=VA

}
C {/home/lci-ufsc/Desktop/Bracolin/TIA_Filter/auxLib/ampOp_ideal.sym} -600 -170 0 0 {name=x2}
C {/home/lci-ufsc/Desktop/Bracolin/TIA_Filter/auxLib/ampOp_ideal.sym} -880 100 0 0 {name=x3}
C {/home/lci-ufsc/Desktop/Bracolin/TIA_Filter/auxLib/ampOp_ideal.sym} -620 100 0 0 {name=x8}
