...
C {devices/lab_wire.sym} 110 -150 0 0 {name=p4 sig_type=std_logic lab=clks}
C {devices/lab_wire.sym} 100 -110 0 0 {name=p5 sig_type=std_logic lab=Vinp}
C {devices/lab_wire.sym} 320 -110 0 0 {name=p6 sig_type=std_logic lab=VDP}
C {/home/electrica/Documents/gf180_projects/gf180_work/PICO_contest/tracking_switches/tracking_switches.sym} 100 360 0 0 {name=x2}
C {devices/lab_wire.sym} 190 110 0 0 {name=p7 sig_type=std_logic lab=VDDA}
C {devices/lab_wire.sym} 110 200 0 0 {name=p8 sig_type=std_logic lab=clks}
...
C {devices/iopin.sym} 820 -40 0 0 {name=p25 lab=Valid}
C {devices/iopin.sym} 820 10 0 0 {name=p26 lab=VDP}
C {devices/iopin.sym} 820 60 0 0 {name=p27 lab=VDN}
