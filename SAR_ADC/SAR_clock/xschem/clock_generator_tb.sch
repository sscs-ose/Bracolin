...
C {devices/lab_wire.sym} 570 -180 0 0 {name=p1 sig_type=std_logic lab=VDDD}
C {devices/gnd.sym} 570 50 0 0 {name=l12 lab=GND}
C {devices/noconn.sym} 800 -70 2 0 {name=l1}
C {devices/lab_wire.sym} 790 -70 0 0 {name=p2 sig_type=std_logic lab=OUT}
...
C {PICO_contest/SAR_logic/xschem/SAR_Logic.sym} 170 -120 0 0 {name=x2}
C {devices/lab_wire.sym} 390 -30 0 0 {name=p7 sig_type=std_logic lab=A}
C {devices/lab_wire.sym} 360 -20 0 0 {name=p25 sig_type=std_logic lab=B}
C {devices/lab_wire.sym} 390 -10 0 0 {name=p26 sig_type=std_logic lab=C}
C {devices/vsource.sym} -580 50 0 0 {name=V2 value=0}
C {devices/gnd.sym} -580 100 0 0 {name=l3 lab=GND}
C {devices/lab_wire.sym} -580 -80 0 0 {name=p27 sig_type=std_logic lab=C}
C {devices/vsource.sym} -660 50 0 0 {name=V5 value=0}
C {devices/gnd.sym} -660 100 0 0 {name=l20 lab=GND}
C {devices/lab_wire.sym} -660 -80 0 0 {name=p28 sig_type=std_logic lab=B}
C {devices/vsource.sym} -730 50 0 0 {name=V6 value=0}
C {devices/gnd.sym} -730 100 0 0 {name=l21 lab=GND}
C {devices/lab_wire.sym} -730 -80 0 0 {name=p29 sig_type=std_logic lab=A}
C {PICO_contest/SAR_clock/xschem/clock_generator.sym} 480 60 0 0 {name=x1}
