...
C {devices/lab_wire.sym} -10 -510 0 0 {name=p1 sig_type=std_logic lab=VDDD}
C {devices/lab_wire.sym} -10 -300 0 0 {name=p2 sig_type=std_logic lab=VSSD}
C {devices/lab_wire.sym} -70 -400 0 0 {name=p3 sig_type=std_logic lab=CLK}
C {devices/lab_wire.sym} 160 -400 0 0 {name=p4 sig_type=std_logic lab=nCLK}
...
C {devices/lab_wire.sym} 1260 180 0 0 {name=p32 sig_type=std_logic lab=CLK_buf}
...
C {PICO_contest/SAR_logic/xschem/inv_1x.sym} -30 -270 0 0 {name=x11}
C {PICO_contest/SAR_logic/xschem/t_gate.sym} 280 40 0 0 {name=x1}
C {PICO_contest/SAR_logic/xschem/nor_2_1x.sym} 930 90 0 0 {name=x2}
C {PICO_contest/SAR_logic/xschem/t_gate.sym} 1130 20 0 0 {name=x4}
C {PICO_contest/SAR_logic/xschem/nor_2_1x.sym} 1710 70 0 0 {name=x6}
...
C {PICO_contest/SAR_logic/xschem/t_gate.sym} 1470 260 3 0 {name=x7}
C {PICO_contest/SAR_logic/xschem/nor_2_1x.sym} 1540 550 0 1 {name=x8}
C {PICO_contest/SAR_logic/xschem/inv_1x.sym} 1890 460 0 0 {name=x9}
...
C {devices/lab_wire.sym} 390 -400 0 0 {name=p46 sig_type=std_logic lab=CLK_buf}
C {PICO_contest/SAR_logic/xschem/inv_1x.sym} 200 -270 0 0 {name=x10}
